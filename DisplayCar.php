       ...
       <h2>Available Cars</h2>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                 echo "<tr><td>" . $row["VehicleModel"] . "</td><td>" . $row["VehicleNumber"] . "</td><td>" . $row["SeatingCapacity"] . "</td><td>" . $row["RentPerDay"] . "</td><td><a href='update.html?VehicleNumber=" . $row['VehicleNumber'] . "'>Update</a> </td>
        </tr>";
            }
            echo "</table>";
        } else {
